...
//In LinkedHashSet if we overrride hashCode() and equals() method and check equality
...
//Since it is LinkedHashSet...book will be stored in the inserted order...i.e 
//insertion order will be preserved.

//if you don't override hashCode() and equals(), then same Book object cannot be saved
//in LinkedHashSet as equality will be checked using hashCode() and equals() method
